      ...
      <div className="about__content_wrapper">
        ...
        <div className="about__text" ref={textBlock}>
          <p>
            ...
            So I am looking for a job in Singapore because I want to "start a
            new life" there, because I think it is a city of future and
            innovation and because I want to be a part of a team in a
            world-class software engineering company. <br />I enjoy writing code
            and learning new technologies daily, as I am very passionate about
            this field.
            <br />
            In my free time I love to listen to intellectual podcasts, to create
            art through drawing and writing, and to learn by reading books and
