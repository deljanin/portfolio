			...
			<div className='about__content_wrapper'>
				...
				<div className='about__text'>
					...
					<p
						...
						style={{ '--order': 3 }}
					>
						I enjoy writing code and learning new technologies daily, as I am very passionate about
						this field.
					</p>
					<p
						ref={(e) => textLines.current.push(e)}
						...
						style={{ '--order': 4 }}
					>
						In my free time I love to listen to intellectual podcasts, to create art through drawing
						and writing, and to learn by reading books and by taking online courses.
					</p>
				</div>
			</div>
		</div>
