        ...
        {projects_data.map((data, index) => {
          if (index === 0) {
            return (
              <Project
                key={data.id}
                bgPath="/src/assets/images/project_1_bg.svg"
                linePath="/src/assets/images/project_start_line.svg"
                bgClass="project1_bg"
            ...
            return (
              <Project
                ...
                bgPath="/src/assets/images/project_5_bg.svg"
                linePath="/src/assets/images/project_end_line.svg"
                bgClass="project5_bg"
            ...
            return (
              <Project
                key={data.id}
                mainTitleDisplay="project__no_display"
                bgPath={"/src/assets/images/project_" + imgIndex + "_bg.svg"}
                linePath="/src/assets/images/project_between_line.svg"
